      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col px-6 py-10 gap-6">
        ...
        {vistaActiva === 'rueda' && (
          <div className="flex flex-col gap-4 items-center">
            <div className="bg-white/8 border border-white/20 rounded-3xl p-5 backdrop-blur w-full flex flex-col items-center" style={{ backgroundColor: 'rgba(255,255,255,0.08)' }}>
