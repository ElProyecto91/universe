...
export default function Rituales() {
  ...
  const generarLectura = async () => {
    ...
    } catch (err) { console.warn('[Rituales] Error caché:', err) }
  ...
  return (
    <div className="min-h-screen text-white flex flex-col relative" style={bgStyle}>
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col px-6 py-10 gap-6">
        ...
        {!cargando && interpretacion && <Compartir titulo="Rituales Estacionales" texto={interpretacion} hashtags={['Universe', 'Rituales']} />}
