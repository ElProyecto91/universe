...
export default function NumerologiaNombre() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('numerologia-nombre', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Numerología del Nombre" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Experta en numerología del nombre (Cheiro/Pitágoras). Nombre: ${nombre}. Aspecto: "${pregunta}". Análisis de la vibración numerológica del nombre completo.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Numerología del Nombre" texto={interpretacion} hashtags={['Universe', 'NumerologiaNombre']} />
