...
export default function Omikuji() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('omikuji', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Omikuji" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'omikuji',
      prompt: `Oráculo Omikuji japonés. Nombre: ${nombre}. Pregunta: "${pregunta}". Respuesta al estilo del Omikuji: fortuna general, consejo específico, advertencia breve.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Omikuji" texto={interpretacion} hashtags={['Universe', 'Omikuji']} />
