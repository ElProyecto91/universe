...
export default function Tzolkin() {
  ...
  const generarLectura = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'tzolkin',
      prompt: `Eres experto en Tzolkín Maya. Nombre: ${nombre}, Signo: ${signo}, Fecha de nacimiento: ${fechaNacimiento}. Genera una lectura profunda y personalizada de 3-4 párrafos. Reflexivo, simbólico, poético. Sin predicciones absolutas.`,
    ...
    if (!result.error && result.texto) {
      ...
      supabase.from('ai_cache').insert({
        cache_key: cacheKey, herramienta: 'tzolkin', prompt_hash: cacheKey,
