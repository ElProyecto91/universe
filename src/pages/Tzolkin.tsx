...
export default function Tzolkin() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('tzolkin', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Tzolkín Maya" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'tzolkin',
      prompt: `Experto en el Tzolkín maya (calendario sagrado de 260 días). Nombre: ${nombre}, Nacimiento: ${fechaNacimiento}. 3 párrafos: signo maya, tono, mensaje del día.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Tzolkín Maya" texto={interpretacion} hashtags={['Universe', 'Tzolkin']} />
