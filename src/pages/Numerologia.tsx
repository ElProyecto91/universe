...
export default function Numerologia() {
  ...
  const generarLectura = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Eres experto en Numerología. Nombre: ${nombre}, Signo: ${signo}, Fecha de nacimiento: ${fechaNacimiento}. Genera una lectura profunda y personalizada de 3-4 párrafos. Reflexivo, simbólico, poético. Sin predicciones absolutas.`,
    ...
    if (!result.error && result.texto) {
      ...
      supabase.from('ai_cache').insert({
        cache_key: cacheKey, herramienta: 'numerologia', prompt_hash: cacheKey,
