...
export default function Numerologia() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('numerologia', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Numerología" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Experta en numerología pitagórica. Nombre: ${nombre}, Nacimiento: ${fechaNacimiento}, Signo: ${signo}. Aspecto a explorar: "${pregunta}". Lectura numerológica profunda.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Numerología" texto={interpretacion} hashtags={['Universe', 'Numerologia']} />
