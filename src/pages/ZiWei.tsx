...
export default function ZiWei() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('zi-wei', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Zi Wei Dou Shu" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'zi-wei',
      prompt: `Experto en Zi Wei Dou Shu (astrología imperial china). Nombre: ${nombre}, Nacimiento: ${fechaNacimiento}, Signo: ${signo}. Lectura de los pilares principales.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Zi Wei Dou Shu" texto={interpretacion} hashtags={['Universe', 'ZiWei']} />
