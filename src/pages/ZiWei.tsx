...
export default function ZiWei() {
  ...
  const generarLectura = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'zi-wei',
      prompt: `Eres experto en Zi Wei Dou Shu. Nombre: ${nombre}, Signo: ${signo}, Fecha de nacimiento: ${fechaNacimiento}. Genera una lectura profunda y personalizada de 3-4 párrafos. Reflexivo, simbólico, poético. Sin predicciones absolutas.`,
    ...
    if (!result.error && result.texto) {
      ...
      supabase.from('ai_cache').insert({
        cache_key: cacheKey, herramienta: 'zi-wei', prompt_hash: cacheKey,
