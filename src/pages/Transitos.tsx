...
export default function Transitos() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('transitos', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Tránsitos Astrales" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Astróloga experta en tránsitos planetarios. Nombre: ${nombre}, Signo: ${signo}, Nacimiento: ${fechaNacimiento}. Tránsitos relevantes para este mes y su impacto.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Tránsitos Astrales" texto={interpretacion} hashtags={['Universe', 'Transitos']} />
