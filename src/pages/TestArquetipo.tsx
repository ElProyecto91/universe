...
export default function TestArquetipo() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('test-arquetipo', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Test de Arquetipos" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Experto en arquetipos junguianos. Nombre: ${nombre}, Signo: ${signo}. Situación: "${pregunta}". Identifica el arquetipo dominante y su mensaje.`,
