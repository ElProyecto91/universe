...
export default function TestArquetipo() {
  ...
  const generarLectura = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Eres experto en Test de Arquetipos. Nombre: ${nombre}, Signo: ${signo}, Fecha de nacimiento: ${fechaNacimiento}. Genera una lectura profunda y personalizada de 3-4 párrafos. Reflexivo, simbólico, poético. Sin predicciones absolutas.`,
    ...
    if (!result.error && result.texto) {
      ...
      supabase.from('ai_cache').insert({
        cache_key: cacheKey, herramienta: 'test-arquetipo', prompt_hash: cacheKey,
