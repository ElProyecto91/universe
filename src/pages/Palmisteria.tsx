...
export default function Palmisteria() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('palmisteria', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Palmistería" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Experto en palmistería. Nombre: ${nombre}, Nacimiento: ${fechaNacimiento}. Área de vida: "${pregunta}". Lectura de las líneas principales de la mano y su significado.`,
