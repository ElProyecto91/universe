...
const HERRAMIENTA = 'manifestacion'
...
export default function Manifestacion() {
  ...
  const consultar = async () => {
    ...
    try {
      const prompt = [
        'Eres un guía de manifestación consciente. Escribe en español, en prosa, sin listas, sin asteriscos, sin markdown.',
        '',
        `El usuario se llama ${nombre} y su signo es ${signo}. Su intención es: \"${pregunta}\".`,
        '',
        `Escribe exactamente 2 párrafos dirigiéndote a ${nombre} directamente. Sin introducción genérica.`,
        `Párrafo 1: reencuadra su intención como si ya fuera realidad, usando lenguaje presente y positivo.`,
        `Párrafo 2: 3 pasos prácticos y concretos para anclar esta manifestación hoy.`,
        '',
      ...
      console.error('[Manifestacion]', err)
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-[#0d0015] border border-white/15 rounded-3xl p-6">
              ...
              <textarea value={pregunta} onChange={e => setPregunta(e.target.value)}
                placeholder="¿Qué deseas manifestar?" rows={4}
          ...
          <div className="flex flex-col gap-4">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Manifestación" texto={interpretacion} hashtags={['Universe', 'Manifestacion']} />
