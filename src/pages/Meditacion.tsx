...
export default function Meditacion() {
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Eres experto en Meditación. Nombre del usuario: ${nombre}, Signo: ${signo}. Situación o pregunta: "${pregunta}". Escribe 3 párrafos reflexivos y simbólicos. Sin predicciones absolutas. Tono cálido y profundo.`,
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col px-6 py-10 gap-6">
        <div className="flex items-center">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-purple-300 text-xs">Práctica de mindfulness</p>
          </div>
        </div>
        {fase === 'preguntar' && (
        ...
        {fase === 'resultado' && (
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && <Compartir titulo="Meditación" texto={interpretacion} hashtags={['Universe', 'Meditacion']} />}
