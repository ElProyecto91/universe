...
export default function SuenosOracle() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('suenos-oracle', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Oracle de Sueños" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Eres un experto en interpretación de sueños (psicología jungiana y simbolismo). Nombre: ${nombre}. Sueño: "${pregunta}". 3 párrafos: símbolos, mensaje, pregunta de reflexión.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Oracle de Sueños" texto={interpretacion} hashtags={['Universe', 'SuenosOracle']} />
