...
export default function VisionBoard() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('vision-board', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Vision Board" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'vision-board',
      prompt: `Guía de manifestación y visualización. Nombre: ${nombre}, Signo: ${signo}. Intención: "${pregunta}". 2 párrafos: cómo visualizarlo y 3 acciones concretas.`,
