...
export default function Bibliomancia() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('bibliomancia', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="Bibliomancia" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Intérprete de bibliomancia. Nombre: ${nombre}. Pregunta: "${pregunta}". Abre un texto al azar (cita un proverbio universal) e interprétalo en relación a la pregunta.`,
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col px-6 py-10 gap-6">
        <div className="flex items-center">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-purple-300 text-xs">Sabiduría de los textos</p>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Bibliomancia" texto={interpretacion} hashtags={['Universe', 'Bibliomancia']} />
