...
export default function CoinOracle() {
  ...
  const lanzar = async () => {
    ...
    const prompt = `Eres un intérprete de oráculos de monedas. La moneda ha sido símbolo de fortuna y decisión en muchas culturas.
...
Escribe una interpretación de 2 párrafos para ${nombre}. Primero explora qué dice este patrón en respuesta a su pregunta específica. Luego ofrece una perspectiva más profunda sobre la situación. Termina con una pregunta de reflexión. No hagas predicciones absolutas.`
    ...
    try {
      ...
      setInterpretacion('Las monedas guardan silencio. Inténtalo de nuevo.')
    }
    setCargando(false)
  }
          ...
          <div className="flex flex-col gap-6">
            <div className="text-center">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                Tres monedas, seis posibles patrones. La aleatoriedad como espejo de la energía presente en tu pregunta.
              </p>
            </div>
        ...
        {fase === 'resultado' && (
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button onClick={() => { setFase('preguntar'); setMonedas([]); setInterpretacion('') }} className="w-full text-purple-300/60 text-sm py-2">
                Nueva tirada
              </button>
            </div>
          </div>
