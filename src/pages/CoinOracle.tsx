...
export default function CoinOracle() {
  ...
  const lanzar = async () => {
    ...
    setCargando(true)
    setErrorMsg('')
    registrarEvento({ herramienta: 'coin-oracle', accion: 'tirada_iniciada', user_id: userId })
  ...
  return (
    <div className="min-h-screen text-white flex flex-col relative" style={bgStyle}>
      ...
      {!esPremium && fase === 'preguntar' && (
        <Paywall motivo="herramienta" herramienta="Oracle de Monedas · Cleromancia" />
      )}
        ...
        {fase === 'resultado' && (
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                <DisclaimerIA />
                <Valoracion herramienta="coin-oracle" userId={userId} />
                <Compartir titulo={`Oracle de Monedas: ${getInterpretacion(monedas).titulo}`} texto={interpretacion} hashtags={['CoinOracle', 'Universe', 'Cleromancia']} />
              </>
            )}
