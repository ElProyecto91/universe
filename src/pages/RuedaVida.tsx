...
export default function RuedaVida() {
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Eres experto en Rueda de la Vida. Nombre del usuario: ${nombre}, Signo: ${signo}. Situación o pregunta: "${pregunta}". Escribe 3 párrafos reflexivos y simbólicos. Sin predicciones absolutas. Tono cálido y profundo.`,
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col px-6 py-10 gap-6">
        ...
        {fase === 'resultado' && (
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && <Compartir titulo="Rueda de la Vida" texto={interpretacion} hashtags={['Universe', 'RuedaVida']} />}
