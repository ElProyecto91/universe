...
export default function RuedaVida() {
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Experto en Rueda de la Vida. Nombre: ${nombre}, Signo: ${signo}. Situación o pregunta: "${pregunta}". 3 párrafos reflexivos y simbólicos. Sin predicciones absolutas.`,
