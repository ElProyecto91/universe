...
export default function RuedaVida() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('rueda-vida', esPremium)
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Coach de desarrollo personal. Nombre: ${nombre}, Signo: ${signo}. Área de vida a explorar: "${pregunta}". Análisis de balance vital con recomendaciones concretas.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="Rueda de la Vida" texto={interpretacion} hashtags={['Universe', 'RuedaVida']} />
