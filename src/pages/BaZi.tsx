...
export default function BaZi() {
  ...
  const { registrarApertura, registrarLectura, registrarPaywall, registrarValoracion } = useAnalytics('bazi', esPremium)
  ...
  if (!cargandoPlan && !esPremium) {
    registrarPaywall()
    return <Paywall motivo="herramienta" herramienta="BaZi · 八字" />
  }
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      herramienta: 'bazi',
      prompt: `Experto en BaZi (Cuatro Pilares del Destino). Nombre: ${nombre}, Nacimiento: ${fechaNacimiento}. Day Master y elementos dominantes. 3-4 párrafos de lectura profunda.`,
          ...
          <div className="flex flex-col gap-5">
            ...
            {!cargando && interpretacion && (
              <>
                ...
                <Compartir titulo="BaZi · 八字" texto={interpretacion} hashtags={['Universe', 'BaZi']} />
