...
export default function Guia() {
  ...
  const systemPrompt = [
    ...
    '',
    'Cuando el usuario haga una pregunta, ofrece diferentes perspectivas para explorar.',
    'Conecta siempre con su perfil. Puedes sugerir tarot o consulta con experto humano cuando lo requiera.',
    'Nunca des respuestas de sí o no. Siempre abre puertas.',
  ...
  return (
    <div className="min-h-screen text-white flex flex-col relative" style={bgStyle}>
      ...
      <div className="relative z-10 flex items-center gap-3 px-4 py-4 border-b border-white/10 backdrop-blur">
        ...
        <button onClick={() => window.location.href = '/tarot'}
