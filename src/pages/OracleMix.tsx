...
export default function OracleMix() {
  ...
  const consultar = async () => {
    ...
    const result = await llamarGemini({
      ...
      prompt: `Eres experto en Oracle Mix. Nombre del usuario: ${nombre}, Signo: ${signo}. Situación o pregunta: "${pregunta}". Escribe 3 párrafos reflexivos y simbólicos. Sin predicciones absolutas. Tono cálido y profundo.`,
