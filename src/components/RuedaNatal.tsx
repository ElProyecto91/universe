...
function SectoresSignos() {
  const cx = 160, cy = 160, rOuter = 148, rSignos = 130
  const sectores: JSX.Element[] = []
  for (let i = 0; i < 12; i++) {
    const signo = ORDEN_SIGNOS[i]
...
function GlifosSignos() {
  const cx = 160, cy = 160, rSignosTxt = 118
...
function LineasCasas() {
  const cx = 160, cy = 160, rInner = 68, rDivisores = 110
...
export default function RuedaNatal({ planetas, nombre }: Props) {
  const cx = 160, cy = 160
  const rOuter = 148, rPlanetas = 88, rInner = 68
